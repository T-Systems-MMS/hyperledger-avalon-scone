...
# -------------------------------------------------------------------------
    ...
    def generate_signing_key(self):
        ...
        #print("generated ECDSA private key : ", self.sign_private_key.to_pem())
        #print("generated ECDSA public key : ", self.sign_public_key.to_pem())

        cas_sign_private_key = os.environ["Sig_Pri_Key"]
        cas_sign_public_key = os.environ["Sig_Pub_Key"]

        cas_sign_private_key=cas_sign_private_key.replace("-----BEGIN EC PRIVATE KEY-----", "start_")
        cas_sign_private_key=cas_sign_private_key.replace("-----END EC PRIVATE KEY-----", "_end")
        cas_sign_private_key=cas_sign_private_key.replace(" ","\n")
        cas_sign_private_key=cas_sign_private_key.replace("start_", "-----BEGIN EC PRIVATE KEY-----")
        cas_sign_private_key=cas_sign_private_key.replace( "_end", "-----END EC PRIVATE KEY-----")
        cas_sign_private_key=cas_sign_private_key.encode("UTF-8")

        cas_sign_public_key=cas_sign_public_key.replace("-----BEGIN PUBLIC KEY-----", "start_")
        cas_sign_public_key=cas_sign_public_key.replace("-----END PUBLIC KEY-----", "_end")
        cas_sign_public_key=cas_sign_public_key.replace(" ","\n")
        cas_sign_public_key=cas_sign_public_key.replace("start_", "-----BEGIN PUBLIC KEY-----")
        cas_sign_public_key=cas_sign_public_key.replace( "_end", "-----END PUBLIC KEY-----")
        cas_sign_public_key=cas_sign_public_key.encode("UTF-8")
        
        #print("CAS ECDSA private key : ", cas_sign_private_key)
        #print("CAS ECDSA public key : ", cas_sign_public_key)
        self.sign_private_key=SigningKey.from_pem(cas_sign_private_key)
        self.sign_public_key=VerifyingKey.from_pem(cas_sign_public_key)
